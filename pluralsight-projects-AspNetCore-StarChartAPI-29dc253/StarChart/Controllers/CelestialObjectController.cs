...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var updatedCelestialObject = _context.CelestialObjects.Find(id);
            if (updatedCelestialObject == null)
                return NotFound();
            updatedCelestialObject.Name = celestialObject.Name;
            updatedCelestialObject.OrbitalPeriod = celestialObject.OrbitalPeriod;
            updatedCelestialObject.OrbitedObjectId = celestialObject.OrbitedObjectId;
            _context.CelestialObjects.Update(updatedCelestialObject);
            _context.SaveChanges();
